namespace Loupedeck.NowPlayingArtworkPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.NowPlayingArtworkPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.NowPlayingArtworkPlugin.Resources.Resource.txt`.
