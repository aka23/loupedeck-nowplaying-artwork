namespace Loupedeck.SpotifyArtworkPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.SpotifyArtworkPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.SpotifyArtworkPlugin.Resources.Resource.txt`.
